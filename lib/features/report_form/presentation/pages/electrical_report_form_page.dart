    ...
    try {
      final report = ReportEntity(
        ...
        operators: _execs
            ...
            .toList(),
        workOrders: _osList.map<WorkOrderEntity>((os) => WorkOrderEntity(
          id: 'os_${DateTime.now().millisecondsSinceEpoch}_${os.hashCode}',
          number: '',
          location: os.local,
          maintenanceType: os.tipo,
          cause: os.causa == 'Outros' ? os.causaOutros : os.causa,
          activities: os.atividades,
          materialsUsed: os.matNA ? [] : [os.materiais],
          quantityMeters: '',
          quantityPieces: '',
          startTime: os.horaIni,
          endTime: os.horaFim,
          osStatus: os.status,
          photoPaths: const [],
        )).toList(),
      ...
      debugPrint('Erro ao salvar relatório de elétrica no Firebase: $e');
    }
